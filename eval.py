...
from umi.real_world.tmi_env import TmiEnv
    ...
    with SharedMemoryManager() as shm_manager:
        with KeystrokeCounter() as key_counter, \
            BimanualUmiEnv(
                ...
                # action
                max_pos_speed=2.0/1000,
                max_rot_speed=6.0/1000,
            ...
            with torch.no_grad():
                ...
                # print("Before:", obs_dict['tac02_0'].shape)
                # The following line does not work for TAC-02 due to addition of a dimension
                obs_dict = dict_apply(obs_dict_np, 
                    lambda x: torch.from_numpy(x).unsqueeze(0).to(device))
                # obs_dict['tac02_0'] = obs_dict['tac02_0'][0]
                # print("After:", obs_dict['tac02_0'].shape)
