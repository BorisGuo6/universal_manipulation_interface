...
from diffusion_policy.policy.diffusion_unet_tmi_policy import DiffusionUnetTMIPolicy
...
class TrainDiffusionUnetTMIWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: DiffusionUnetTMIPolicy = hydra.utils.instantiate(cfg.policy)

        self.ema_model: DiffusionUnetTMIPolicy = None
...
def main(cfg):
    workspace = TrainDiffusionUnetTMIWorkspace(cfg)
    workspace.run()
